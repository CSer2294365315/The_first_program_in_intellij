...
public class J_9_7_12
{
    public static void main(String[] args)
    {
        EventQueue.invokeLater(() ->
        {
            ButtonFrame_ frame = new ButtonFrame_();
...
class ImageFrame_ extends JFrame
{
    private static final int DEFAULT_WIDTH=450;
    private static final int DEFAULT_HEIGHT=350;

    public ImageFrame_(Image image)
    {
        setTitle("Capture");
        setSize(DEFAULT_WIDTH,DEFAULT_HEIGHT);

        JLebel label_2=new JLabel(new ImageIcon(image));
     //   add(label);
    }
}
...
class ButtonFrame_  extends JFrame
{
